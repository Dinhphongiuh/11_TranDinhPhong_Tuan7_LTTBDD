...
export default function Screen04({navigation, route}) {
  ...
  const [jobInput, setJobInput] = useState(route.params.jobToEdit.jobName);
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.ContainerAddText}>
        <Text style={styles.addText}>EDIT YOUR JOB</Text>
      </View>
      ...
      <TouchableOpacity
        ...
        // onPress={() => navigation.navigate("Screen02", {name: name, updatedJob: jobInput})}
